  ...
  <div>
    ...
    <div class="group-info-content">
      ...
      <div class="info-item">
        ...
        <div
          class="long-content"
          :title="groupProfile.notification"
      ...
      <div class="info-item" v-if="groupProfile.type !== 'Private'">
        ...
        >{{ joinOptionMap[groupProfile.joinOption] }}</div>
        <el-select
          ref="editJoinOption"
          v-model="joinOption"
          v-show="showEditJoinOption"
      ...
      <div class="info-item">
        ...
        <div
          ...
          v-if="!showEditNameCard"
        >{{ groupProfile.selfInfo.nameCard || '暂无' }}</div>
        <el-input
          ref="editNameCard"
          v-else
          autofocus
...
export default {
  ...
  computed: {
    ...
    isOwner() {
      return (
        this.groupProfile.selfInfo.role === this.TIM.TYPES.GRP_MBR_ROLE_OWNER
      );
    },
    isAdmin() {
      return (
