                        ...
                        <tr class="tbody">
                            ...
                            <td>
                                ...
                                <span
                                    class="price"
                                    v-if="type==1"
                                >{{(info.riftPrice/100).toFixed(2)}}</span>
                            ...
                            <td>
                                ...
                                <span
                                    class="price"
                                    v-if="type==1"
                                >{{((info.riftPrice/100)*num).toFixed(2)}}</span>
                                <span
                                    class="price"
                                    v-else
                                >{{ ((info.tacticsPrice/100)*num).toFixed(2)}}</span>
                            </td>
                        </tr>
                    </table>
...
export default {
    ...
    mounted() {
        ...
        this.info = sessionStorage.getItem("_info")
            ? JSON.parse(sessionStorage.getItem("_info"))
            : "";
        if (!this.info) {
            this.gotUserInfo();
        }
    ...
    methods: {
        ...
        async toOrder() {
            let price =
                this.type == 1 ? this.info.riftPrice : this.info.tacticsPrice;
